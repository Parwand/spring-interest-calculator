...
class ZinsTest {
    ...
    @Test
    @DisplayName("Mit Anfangskapital 1000 €, 100 Jahren Laufzeit  und 0 % Zinssatz soll Endkapital auch beim 1000€ bleiben ")
    void test_5() {
        // Arrange
        Zins zins = new Zins();
        zins.setAnfangskapital(1000);
        zins.setLaufzeit(100);
        zins.setZinssatz(0);
        // Act
        zins.zinsenBerechnen();
    ...
    @Test
    @DisplayName("Mit Anfangskapital 1000 €, 0 Jahren Laufzeit  und 100 % Zinssatz soll Endkapital auch 1000€ betragen ")
    void test_6() {
        // Arrange
        Zins zins = new Zins();
        zins.setAnfangskapital(1000);
